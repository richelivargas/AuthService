...
/**
 * Classes to deal with our clients, which are the resource servers whose wants
 * to use the authentication. Let’s start the class who represents the detail of
 * an authorization client.
 * 
