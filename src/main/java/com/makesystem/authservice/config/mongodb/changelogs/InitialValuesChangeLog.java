package com.makesystem.authservice.config.mongodb.changelogs;
...
public class InitialValuesChangeLog {
    ...
    @ChangeSet(order = "001", id = "insertBrowserClientDetails", author = "Richeli Vargas")
    ...
    @ChangeSet(order = "002", id = "insertUserToTestAuthentication", author = "Richeli Vargas")
    ...
    @ChangeSet(order = "003", id = "insertAccountServiceClientDetails", author = "Richeli Vargas")
