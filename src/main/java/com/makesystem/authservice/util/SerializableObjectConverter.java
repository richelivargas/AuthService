package com.makesystem.authservice.util;
...
public class SerializableObjectConverter {
	...
	public static String serialize(final OAuth2Authentication object) {
		byte[] bytes = SerializationUtils.serialize(object);
		return Base64.encodeBase64String(bytes);
	}

	public static OAuth2Authentication deserialize(final String encodedObject) {
